...
13. [Legacy admin panel](#legacy-admin-panel)
...
Legacy admin panel — это standalone HTML-страница с JavaScript для быстрого доступа администраторов к основным функциям системы без необходимости использовать React SPA.
...
1. **JWT-аутентификация** — вход с email и паролем, хранение токена в localStorage
2. **CRUD студентов** — просмотр списка, добавление, редактирование, удаление
3. **Парсинг вакансий** — форма для парсинга с hh.ru
4. **Статистика тегов** — топ навыков с визуализацией (Chart.js)
5. **Оценка студента** — ввод параметров и просмотр результата
...
1. Открыть http://localhost:8000/admin-panel
2. Ввести email и пароль администратора
3. После входа доступны все функции
...
❌ Дублирование логики с React SPA  
❌ Нет типизации (TypeScript)  
❌ Сложно масштабировать при росте функционала  
